...
type AccessTypeParam struct {
	Value AccessType `protobuf:"varint,1,opt,name=value,proto3,enum=junction.wasm.AccessType" json:"value,omitempty" yaml:"value"`
}
...
type AccessConfig struct {
	Permission AccessType `protobuf:"varint,1,opt,name=permission,proto3,enum=junction.wasm.AccessType" json:"permission,omitempty" yaml:"permission"`
	// Address
...
type Params struct {
	...
	InstantiateDefaultPermission AccessType   `protobuf:"varint,2,opt,name=instantiate_default_permission,json=instantiateDefaultPermission,proto3,enum=junction.wasm.AccessType" json:"instantiate_default_permission,omitempty" yaml:"instantiate_default_permission"`
}
