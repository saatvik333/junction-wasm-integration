...
func (*MsgIBCSend) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b357cdeeba4771, []int{0}
}
...
func (*MsgIBCSendResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b357cdeeba4771, []int{1}
}
...
func (*MsgIBCCloseChannel) Descriptor() ([]byte, []int) {
	return fileDescriptor_77b357cdeeba4771, []int{2}
}
...
func init() {
	proto.RegisterType((*MsgIBCSend)(nil), "junction.wasm.MsgIBCSend")
	proto.RegisterType((*MsgIBCSendResponse)(nil), "junction.wasm.MsgIBCSendResponse")
	proto.RegisterType((*MsgIBCCloseChannel)(nil), "junction.wasm.MsgIBCCloseChannel")
}

func init() { proto.RegisterFile("junction/wasm/ibc.proto", fileDescriptor_77b357cdeeba4771) }

var fileDescriptor_77b357cdeeba4771 = []byte{
	// 334 bytes of a gzipped FileDescriptorProto
	,
}
