...
var (
	pattern_Query_ContractInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"junction", "wasm", "contract", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ContractHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"junction", "wasm", "contract", "address", "history"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ContractsByCode_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"junction", "wasm", "code", "code_id", "contracts"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_AllContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"junction", "wasm", "contract", "address", "state"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RawContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"junction", "wasm", "contract", "address", "raw", "query_data"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SmartContractState_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"junction", "wasm", "contract", "address", "smart", "query_data"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Code_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"junction", "wasm", "code", "code_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Codes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"junction", "wasm", "code"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_PinnedCodes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"junction", "wasm", "codes", "pinned"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"junction", "wasm", "codes", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ContractsByCreator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"junction", "wasm", "contracts", "creator", "creator_address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BuildAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"junction", "wasm", "contract", "build_address"}, "", runtime.AssumeColonVerbOpt(false)))
)
